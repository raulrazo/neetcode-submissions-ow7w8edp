class Solution:
    def merge(self, intervals: List[List[int]]) -> List[List[int]]:
        ...
        # A-DNU: Sorts the intervals in-place by their start values (pair[0]).
        # A-DNU: A lambda is just a shorthand way to write a small, one-line, unnamed function in Python.
        # A-DNU: intervals.sort(key=lambda pair: pair[0]) is the same as
